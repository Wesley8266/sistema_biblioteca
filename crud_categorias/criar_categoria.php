...
<body class="flex flex-col justify-content items-center bg-[#1E1814]">
    ...
    <form action="processamento.php" method="post" class="flex flex-col items-center justify-center gap-5 bg-[#1a1311] border-2 border-[#3D2B1F] rounded-3xl m-20 p-10 shadow-2xl w-[600px] h-[400px] space-y-6">
