    ...
    <form action="processamento.php" method="post" class="flex flex-col items-center justify-center gap-5 bg-[#1a1311] border-2 border-[#3D2B1F] rounded-3xl m-20 p-10 shadow-2xl w-[600px] h-[450px] space-y-6">
        ...
        <div class="flex flex-col gap-2 items-start">
            <div class="flex flex-row gap-2">
                ...
                <input type="text" name="categoria" placeholder="Ficção,Romance, Terror..." class="bg-[#1E1814] border-2 border-[#3D2B1F] focus:outline-none focus:border-[#A67C00] transition-all text-white rounded-3xl p-4 w-[510px]" required >
         </div>
            <?php
                if(isset($_GET['msg'])){
